...
(function() {
  ...
  window.conn.init_connection = function(game_id, user_id, host) {
    ...
    window.conn.channel.bind('win', function(msg) {
      return console.log('You win');
    });
    return window.conn.channel.bind('lose', function(msg) {
  ...
  window.conn.update_player = function(user_id, old_state, new_state) {
    return window.conn.dispatcher.trigger('update_player', {
      user_id: user_id,
...
(function() {
  ...
  window.game.draw_grid = function(canvas, grid, players) {
    var elem, i, iterator, row, x, y, _i, _j, _len, _len1, _ref, _results;
    x = 0;
    y = 0;
    iterator = -1;
    i = 0;
  ...
  window.game.draw_has_bomb = function(canvas, x, y) {
  ...
  window.game.draw_player = function(canvas, x, y, head_color, eyes_colo, body_color, limbs_color) {
    return canvas.drawRect({
  ...
  window.game.update = function() {
    var new_position, old_position, x, y;
